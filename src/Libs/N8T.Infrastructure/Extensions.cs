...
namespace N8T.Infrastructure
{
    ...
    public static class Extensions
    {
        ...
        public static async Task RelayAndPublishEvents(this IAggregateRoot aggregateRoot, IPublishEndpoint publisher, CancellationToken cancellationToken = default)
        {
